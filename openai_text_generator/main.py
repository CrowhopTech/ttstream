...
async def main():
    ...
    output_redis_queue_name = env.str("REDIS_TEXT_OUTPUT_QUEUE_NAME", default="queues:generated_text")
    redis_status_output_name = env.str("REDIS_STATUS_OUTPUT_NAME", default="statuses:openai_text_generator")
